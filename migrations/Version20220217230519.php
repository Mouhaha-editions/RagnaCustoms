 ...
 */
final class Version20220217230519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE score_historyty (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE score_history ADD song_id INT DEFAULT NULL, ADD song_difficulty_id INT DEFAULT NULL');
        ...
        $this->addSql('UPDATE score_history SET song_id = (SELECT song_hash.song_id FROM song_hash WHERE song_hash.hash = score_history.hash LIMIT 0,1) WHERE score_history.song_id IS NULL ;');
        $this->addSql('UPDATE score_history SET song_difficulty_id = (SELECT sd.id FROM song_difficulty sd LEFT JOIn difficulty_rank r ON sd.difficulty_rank_id = r.id WHERE r.level = score_history.difficulty LIMIT 0,1) WHERE score_history.song_difficulty_id IS NULL ;');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score_history DROP song_id, DROP song_difficulty_id, CHANGE difficulty difficulty VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE hash hash VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
