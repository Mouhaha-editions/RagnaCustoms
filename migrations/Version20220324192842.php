 ...
 */
final class Version20220324192842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score CHANGE hash hash VARCHAR(255) DEFAULT NULL');
        $this->addSql('TRUNCATE score');
        $this->addSql('TRUNCATE score_history');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE score CHANGE hash hash VARCHAR(255) NOT NULL');
