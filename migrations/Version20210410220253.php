 ...
 */
final class Version20210410220253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD steam_community_id VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL  DEFAULT NOW()');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP steam_community_id, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE view_counter DROP FOREIGN KEY FK_E87F8182A0BDB2F3');
        $this->addSql('ALTER TABLE view_counter DROP FOREIGN KEY FK_E87F8182A76ED395');
