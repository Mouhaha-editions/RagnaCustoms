 ...
 */
final class Version20210718223106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO ext_translations (SELECT NULL,"fr","App\\Entity\\CmsBlock","content",id,content FROM block_cms)');
        $this->addSql('INSERT INTO ext_translations (SELECT NULL,"en","App\\Entity\\CmsBlock","content",id,content FROM block_cms)');
    }
