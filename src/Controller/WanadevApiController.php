...
class WanadevApiController extends AbstractController
{
    ...
    #[Route(path: '/wanapi/score/{apiKey}/{osef}-{hash}/{oseftoo}/{oseftootoo}/board', name: 'wd_api_score_get_new', methods: ['GET', 'POST'])]
    public function scoreboard(Request                  $request, ManagerRegistry $doctrine, string $apiKey, string $hash,
